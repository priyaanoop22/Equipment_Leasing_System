...
class IMS:
    def __init__(self,root):
        ...
        title=Label(self.root, text="Equipment Leasing System",image=self.icon_title,compound=LEFT, font=("times new roman",40,"bold"),bg="#010c48",fg="white",anchor="w",padx=20).place(x=0,y=0,relwidth=1,height=70)
        ...
        #clock
        self.lbl_clock=Label(self.root, text="Welcome to Equipment Leasing System \t\t Date: DD-MM-YYYY \t\t Time: HH:MM:SS",font=("times new roman",15),bg="#4d636d",fg="white")
        ...
        btn_exit=Button(LeftMenu,text="Approvals",command=self.approval,image=self.icon_side,compound=LEFT,padx=5,anchor="w",font=("times new roman",20,"bold"),bg="white",bd=3,cursor="hand2").pack(side=TOP,fill=X)
        ...
        self.lbl_category=Label(self.root,text="Total Category \n [0]",bd=5,relief=RIDGE,bg="#23E0D2",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_category.place(x=1000,y=120,height=150,width=300)

        self.lbl_product=Label(self.root,text="Total Product \n [0]",bd=5,relief=RIDGE,bg="#A3E00D",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_product.place(x=300,y=300,height=150,width=300)

        self.lbl_sales=Label(self.root,text="Total Sales \n [0]",bd=5,relief=RIDGE,bg="#B11ECB",fg="white",font=("goudy old style",20,"bold"))
        self.lbl_sales.place(x=650,y=300,height=150,width=300)


         #footer
        lbl_footer=Label(self.root, text="Equipment Leasing System | Developed by Priya Anoop\n This is done for the python project submission for Shiash",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#____________________________
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(text=f"Welcome to Equipment Leasing System \t\t Date: {str(date_)} \t\t Time: {str(time_)}",font=("times new roman",15),bg="#4d636d",fg="white")
