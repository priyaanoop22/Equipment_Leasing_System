...
class productClass:
    def __init__(self, root):
        ...
        product_Frame.place(x=10, y=10, width=450, height=550)

        # title
        title = Label(product_Frame, text="Manage Product Details", font=("times new roman", 15), bg="#0f4d7d",
        ...
        lbl_supplier = Label(product_Frame, text="Supplier", font=("times new roman", 15), bg="white").place(x=30,
                                                                                                             y=110)
        lbl_product_name = Label(product_Frame, text="Name", font=("times new roman", 15), bg="white").place(x=30,
                                                                                                             y=160)
        lbl_price = Label(product_Frame, text="Price", font=("times new roman", 15), bg="white").place(x=30, y=210)
        lbl_qty = Label(product_Frame, text="Quantity", font=("times new roman", 15), bg="white").place(x=30, y=260)
        ...
        txt_name = Entry(product_Frame, textvariable=self.var_name, font=("times new roman", 15),
                         bg='lightgreen').place(x=150, y=160, width=200)
        txt_price = Entry(product_Frame, textvariable=self.var_price, font=("times new roman", 15),
                          bg='lightgreen').place(x=150, y=210, width=200)
        txt_qty = Entry(product_Frame, textvariable=self.var_qty, font=("times new roman", 15), bg='lightgreen').place(
        ...
        btn_clear = Button(product_Frame, text="Clear", command=self.clear, font=("goudy old style", 15), bg="#a334ac",
                           fg="white", cursor="hand2").place(x=340, y=400, width=100, height=40)

        # search
        SearchFrame = LabelFrame(self.root, text="Search Product", font=("gouldy old style", 12, "bold"), bd=2,
        ...
        p_frame.place(x=480, y=100, width=600, height=460)
