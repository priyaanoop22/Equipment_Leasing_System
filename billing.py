...
class BillClass:
    def __init__(self, root):
        self.root = root
        self.root.geometry("1375x710+0+0")
        ...
        title = Label(self.root, text="Equipment Leasing System", image=self.icon_title, compound=LEFT,
        ...
        self.lbl_clock = Label(self.root,
                               text="Welcome to Equipment Leasing System \t\t Date: DD-MM-YYYY \t\t Time: HH:MM:SS",
        ...
        pTitle = Label(ProductFrame1, text="All Products", font=("times new roman", 20, "bold"), bg="#262626",
        ...
        txt_search = Entry(ProductFrame2, textvariable=self.var_search, font=("times new roman", 15),
                           bg="lightgreen").place(x=128, y=47, width=150, height=22)
        btn_search = Button(ProductFrame2, text="Search", command=self.search, font=("times new roman", 15), bg="blue",
                            fg="white", cursor="hand2").place(x=285, y=45, width=100, height=25)

        btn_show_all = Button(ProductFrame2, text="Show All", command=self.show, font=("times new roman", 15),
                              bg="blue", fg="white", cursor="hand2").place(x=285, y=10, width=100, height=25)

        # Product Details 
        ProductFrame3 = Frame(ProductFrame1, bd=3, relief=RIDGE)
        ProductFrame3.place(x=2, y=142, width=398, height=380)
        ...
        lbl_note = Label(ProductFrame1, text="Note: 'Enter 0 QTY to Remove product from cart'",
                         font=("times new roman", 11), anchor='w', bg="white", fg="red").pack(side=BOTTOM, fill=X)
        ...
        cTitle = Label(CustomerFrame, text="Lessee Details", font=("times new roman", 15), bg="lightgray").pack(
            side=TOP, fill=X)
        lbl_name = Label(CustomerFrame, text="Name", font=("times new roman", 15), bg="white").place(x=5, y=35)
        txt_name = Entry(CustomerFrame, textvariable=self.var_cname, font=("times new roman", 13),
                         bg="lightgreen").place(x=80, y=35, width=180)

        lbl_contact = Label(CustomerFrame, text="Contact No.", font=("times new roman", 15), bg="white").place(x=270,
                                                                                                               y=35)
        txt_contact = Entry(CustomerFrame, textvariable=self.var_contact, font=("times new roman", 13),
                            bg="lightgreen").place(x=380, y=35, width=140)
        ...
        txt_cal_input = Entry(Cal_Frame, textvariable=self.var_cal_input, font=('arial', 15, 'bold'), width=21, bd=10,
                              relief=GROOVE, justify=RIGHT, state='readonly')
        ...
        btn_C = Button(Cal_Frame, text='C', font=('arial', 15, 'bold'), command=self.clear_calls, bd=5, width=4,
                       pady=15, cursor="hand2").grid(row=4, column=1)
        ...
        # Menu Frame to Add cart buttons
        ...
        txt_p_name = Entry(Add_CartWidgetsFrame, textvariable=self.var_pname, font=("times new roman", 15),
                           bg="lightgreen", state='readonly').place(x=5, y=35, width=190, height=22)
        ...
        txt_p_price = Entry(Add_CartWidgetsFrame, textvariable=self.var_price, font=("times new roman", 15),
                            bg="lightgreen", state='readonly').place(x=230, y=35, width=150, height=22)
        ...
        txt_p_qty = Entry(Add_CartWidgetsFrame, textvariable=self.var_qty, font=("times new roman", 15),
                          bg="lightgreen").place(x=390, y=35, width=120, height=22)
        ...
        bTitle = Label(billFrame, text="Lessee Bills", font=("times new roman", 20, "bold"), bg="#f44335",
                       fg="white").pack(side=TOP, fill=X)
        ...
        self.lbl_amt = Label(billMenuFrame, text="Bill Amount \n[0]", font=("arial", 13, "bold"), bg="lightblue",
                             fg="white")
        self.lbl_amt.place(x=2, y=5, width=120, height=70)

        self.lbl_discount = Label(billMenuFrame, text="Discount \n[5%]", font=("arial", 15, "bold"), bg="orange",
                                  fg="white")
        self.lbl_discount.place(x=124, y=5, width=120, height=70)

        self.lbl_net_pay = Label(billMenuFrame, text="Net Pay \n[0]", font=("arial", 15, "bold"), bg="cyan", fg="white")
        self.lbl_net_pay.place(x=246, y=5, width=160, height=70)

        btn_print = Button(billMenuFrame, text="Print", command=self.print_bill, font=("arial", 12, "bold"), bg="pink",
                           fg="white", cursor="hand2")
        btn_print.place(x=2, y=80, width=120, height=50)

        btn_clear_all = Button(billMenuFrame, text="Clear All", command=self.clear_all, font=("arial", 12, "bold"),
                               bg="green", fg="white", cursor="hand2")
        btn_clear_all.place(x=124, y=80, width=120, height=50)

        btn_generate = Button(billMenuFrame, text="Generate/Save Bill", command=self.generate_bill,
                              font=("arial", 12, "bold"), bg="purple", fg="white", cursor="hand2")
        btn_generate.place(x=246, y=80, width=160, height=50)

        # footer
        lbl_footer = Label(self.root,
                           text="Equipment Leasing System | Developed by Priya Anoop\n This is done for the python project submission for Shiash",
                           font=("times new roman", 12), bg="#4d636d", bd=0, fg="white").pack(side=BOTTOM, fill=X)
        self.show()
        ...
        if self.var_pid.get() == '':
            ...
            if present == 'yes':
                op = messagebox.askyesno('Confirm',
                                         "Product already Present\nDo you want to Update or Remove the Product from cart?",
                                         parent=self.root)
                if op == True:
    ...
    def bill_updates(self):
        ...
        self.lbl_amt.config(text=f'Bill Amnt. (Rs.)\n[{str(self.bill_amnt)}]')
    ...
    def generate_bill(self):
        if self.var_cname.get() == '' or self.var_contact.get() == '':
            messagebox.showerror("Error", f"Lessee Details Required", parent=self.root)
...
{str("=" * 47)}
 Lessee Name: {self.var_cname.get()}
...
{str("=" * 47)}\n
    ...
    def update_date_time(self):
        ...
        self.lbl_clock.config(
            text=f"Welcome to Equipment Leasing System \t\t Date: {str(date_)} \t\t Time: {str(time_)}",
            font=("times new roman", 15), bg="#4d636d", fg="white")
