...
class salesClass:
    def __init__(self,root):
        ...
        #title
        lbl_title=Label(self.root,text="View Customer Bill",font=("times new roman",30),bg="#184a45",fg="white",bd=3,relief=RIDGE).pack(side=TOP,fill=X,padx=10,pady=2)

        lbl_invoice=Label(self.root,text="Invoice No.",font=("times new roman",15),bg="white").place(x=50,y=100)
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman",15),bg="lightgreen").place(x=160,y=100,width=180,height=28)
        ...
        bill_Frame.place(x=280,y=140,width=410,height=400)
