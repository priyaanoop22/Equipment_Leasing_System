...
class supplierClass:
    def __init__(self, root):
        ...
        txt_search = Entry(self.root, textvariable=self.var_searchtxt, font=("goudy old style", 15),
                           bg="lightgreen").place(x=800, y=80, width=160)
        ...
        # title
        title = Label(self.root, text="Supplier Details", font=("times new roman", 20), bg="#0f4d7d", fg="white").place(
            x=50, y=10, height=40, width=1000)

        # content
        # row1
        lbl_supplier_invoice = Label(self.root, text="Invoice No.", font=("times new roman", 15), bg="white").place(
            x=50, y=80)
        txt_supplier_invoiced = Entry(self.root, textvariable=self.var_sup_invoice, font=("times new roman", 15),
                                      bg="lightgreen").place(x=180, y=80, width=180)
        # row2
        ...
        txt_contact = Entry(self.root, textvariable=self.var_contact, font=("times new roman", 15),
                            bg="lightgreen").place(x=180, y=160, width=180)
